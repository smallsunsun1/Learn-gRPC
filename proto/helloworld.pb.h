...
// repeated int32 index = 2;
inline int HelloRequest::_internal_index_size() const {
  return index_.size();
}
inline int HelloRequest::index_size() const {
  return _internal_index_size();
}
inline void HelloRequest::clear_index() {
  index_.Clear();
}
inline ::PROTOBUF_NAMESPACE_ID::int32 HelloRequest::_internal_index(int index) const {
  return index_.Get(index);
}
inline ::PROTOBUF_NAMESPACE_ID::int32 HelloRequest::index(int index) const {
  // @@protoc_insertion_point(field_get:helloworld.HelloRequest.index)
  return _internal_index(index);
}
inline void HelloRequest::set_index(int index, ::PROTOBUF_NAMESPACE_ID::int32 value) {
  index_.Set(index, value);
  // @@protoc_insertion_point(field_set:helloworld.HelloRequest.index)
}
inline void HelloRequest::_internal_add_index(::PROTOBUF_NAMESPACE_ID::int32 value) {
  index_.Add(value);
}
inline void HelloRequest::add_index(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_add_index(value);
  // @@protoc_insertion_point(field_add:helloworld.HelloRequest.index)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::int32 >&
HelloRequest::_internal_index() const {
  return index_;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::int32 >&
HelloRequest::index() const {
  // @@protoc_insertion_point(field_list:helloworld.HelloRequest.index)
  return _internal_index();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::int32 >*
HelloRequest::_internal_mutable_index() {
  return &index_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::int32 >*
HelloRequest::mutable_index() {
  // @@protoc_insertion_point(field_mutable_list:helloworld.HelloRequest.index)
